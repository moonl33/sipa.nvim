...
return {
  ...
  config = function()
    ...
    -- Config from old setuo
    vim.keymap.set('n', '<Leader>db', dap.clear_breakpoints, { desc = 'Debug: Delete all breakpoints' })
